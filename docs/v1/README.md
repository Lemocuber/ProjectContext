...
Launch hardening note (2026-03-06): v1 supports build-time defaults from `mobile/assets/ProjectContext.config.txt` (JSON payload) with section hide/discard behavior and internal COS runtime policy knobs.
