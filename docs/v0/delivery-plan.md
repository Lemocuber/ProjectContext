...
- Add History tab with popup detail card for session details.
- Add in-app player UI with draggable progress and time labels for saved audio.
...
- Tapping history entry opens detail card with full transcript.
- Session history entry includes saved local audio file reference and in-app player UI.
